...
android {
    ...
    compileOptions {
        // SceneView ships inline functions compiled for JVM 21, so the app must match.
...
dependencies {
    ...
    // Networking (Home Assistant backend)
    ...
    // On-device tests: drive the real UI over ARCore (emulator virtual scene or a phone).
